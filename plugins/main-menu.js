...
let text = `
Hai Kak ${name} ${ucpn}
Smart Bot adalah Bot WhatsApp yang di buat oleh
seorang pelajar yang di bangun menggunakan bahasa pemrograman
Javascript dan di jalankan melalui NodeJs

Berikut merupakan list yang tersedia di Smart Bot

*.allmenu :* Menampilkan seluruh fitur yang tersedia di Smart Bot

*.simplemenu :* Menampilkan Menu Simple yang tersedia di Smart Bot
